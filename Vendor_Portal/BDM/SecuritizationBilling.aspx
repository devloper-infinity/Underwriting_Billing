<%@ Page Title="" Language="C#" MasterPageFile="~/BDM/BDM.Master" AutoEventWireup="true" CodeBehind="SecuritizationBilling.aspx.cs" Inherits="Vendor_Portal.BDM.SecuritizationBilling" %>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-one-tabContent_addinvocie">
                            <div class="tab-pane fade show active" id="custom-tabs-one-home_company" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab_company">
                                ...
                                <table class="table table-bordered" id="secbill_table" style="display:none;">
                                    <thead>
                                        <tr>
                                            <th>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Supplementary PH Review</b></td>
                                            <td style="text-align: center;">
                                                <input type="number" id="secbill_sph_loancount" onchange="onsphratechange();" name="secbill_mike_loancount" class="form-control" style="width: 100px; display: inline;" />
                                            </td>
                                            <td style="text-align: center;">
                                                <input type="number" id="secbill_sph_hours" onchange="onsphratechange();" name="secbill_mike_hours" class="form-control" style="width: 100px; display: inline;" />
                                            </td>
                                            <td style="text-align: center;">
                                                <label id="secbill_sph_rateperfile" class="bootstrap-switch-lightblue"></label>
                                            </td>
                                            <td style="text-align: center;">
                                                <label id="secbill_sph_hourlyrate" class="bootstrap-switch-lightblue"></label>
                                            </td>
                                            <td style="text-align: center;">
                                                <label id="secbill_sph_total" class="bootstrap-switch-lightblue"></label>
                                            </td>
                                        </tr>
                                        <tr>
